...
const metaConfig: Record<string, LocaleMeta> = {
  uz: {
    ...
    keywords: [
      ...
      "Ansor Edu Toshkent",
      // Core offering
      "Saudiya universiteti grant",
      "to'liq grant Saudiya",
      "Saudiya stipendiyasi",
      "xorijda bepul o'qish",
      "Arab universitetlari grant",
      "to'liq stipendiya",
      // Universities
      "Madina Islom Universiteti",
      "IUM grant",
      "Malik Abdulaziz Universiteti",
      "KAU stipendiya",
      "KAUST grant",
      "Al-Azhar universiteti",
      "Umm al-Qura universiteti",
      "Imom Muhammad Ibn Saud universiteti",
      "Qirol Faxd universiteti",
      "KFUPM",
      "Taibah universiteti",
      "Qatar universiteti",
      "Khalifa universiteti",
      // Subjects
      "shariat o'qish Saudiya",
      "arab tili kursi Saudiya",
      "islom ilmi",
      "Qur'on hafizi o'qishi",
      "tibbiyot Saudiya",
      "muhandislik granti",
      "IT Saudiya universiteti",
      // Process
      "Saudiyaga hujjat topshirish",
      "Saudiya viza yordam",
      "ta'lim konsalting O'zbekiston",
      "xorijda o'qish konsultatsiya",
      "grant uchun ariza",
      "Saudiya elchixonasi tasdiq",
      // Geo
      "O'zbekiston Saudiya ta'lim",
      "Konsalting markazi",
    ].join(", "),
    ogLocale: "uz_UZ",
  ...
  ru: {
    ...
    keywords: [
      ...
      "KFUPM",
      "Таибах университет",
      "шариат обучение Саудовская Аравия",
      "арабский язык курс",
      "исламское образование за рубежом",
      "медицина Саудовская Аравия",
      "инженерия грант Саудовская Аравия",
      "документы для поступления",
      "помощь с визой Саудовская Аравия",
      "консалтинг образование Узбекистан",
  ...
  kg: {
    ...
    keywords: [
      "Ansor Edu",
      "Сауд Аравиясы гранты",
      "толук грант университет",
      "Мадина Ислам университети",
      "IUM гранты",
      "Король Абдулазиз университети",
      "KAU стипендиясы",
      "KAUST",
      "Аль-Азхар",
      "акысыз окуу чет өлкөдө",
      "шариат окуу Сауд Аравиясы",
      "Кыргызстан консалтинг билим",
      "Анsor Edu Бишкек",
      "Araб университеттери гранты",
    ].join(", "),
    ogLocale: "ky_KG",
  ...
  en: {
    ...
    keywords: [
      ...
      "Arab university grant",
      "Islamic University of Madinah scholarship",
      "King Abdulaziz University grant",
      "KAUST scholarship",
      "Al-Azhar scholarship",
      "Umm al-Qura University",
      "King Fahd University KFUPM",
      "Taibah University",
      "study in Saudi Arabia free",
      "Saudi student visa help",
      "Islamic studies scholarship",
      "Quran scholarship Saudi",
      "Sharia law degree Saudi Arabia",
      "engineering scholarship Saudi",
      "medicine scholarship Saudi Arabia",
      "IT scholarship Arab countries",
      "education consulting Uzbekistan",
      "Ansor Edu Tashkent",
      "apply Saudi university",
      "Arab world scholarship 2025",
    ].join(", "),
    ogLocale: "en_US",
